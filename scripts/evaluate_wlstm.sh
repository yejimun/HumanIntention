                ...
                for end_mask in ""; do
                    ...
                    # for dataset_ver in 0 25 50 75; do # !!
                        for compute_baseline in --compute_baseline; do
                            ...
                            python -u scripts/train_evaluate_wlstm.py --dataset_ver $dataset_ver --num_epochs 10000 --save_epochs 50 $compute_baseline --batch_size 64 \
