...
def filtering_datasets():
    ...
    # !! Use all the test data since we only have 12 for now.
    ...
    # sample_true_list = traj_true_test[test_data_start_idx:test_data_end_idx] # !! added [:4] for faster learning
    start_percent, end_percent = 0., 1.
    sample_true_list = traj_true_test
...
def arg_parse():
    ...
    parser.add_argument('--num_epochs', default=10000, type=int) # !! 200 --> 10000
    # Model Options
    ...
    parser.add_argument('--particle_num_per_intent', default=10, type=int,\
        help="10, 30, 50, 100.")
    parser.add_argument('--num_tpp', default=5, type=int, help="12, 20") # !! default=20 -->  5
